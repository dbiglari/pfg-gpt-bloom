...
void load_layer_container_thr(int modelindex, int layernum, int thr)
{
...

  {
    ...
    if ((global_numthreads >= 12 && thr == 0) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
    ...
    if ((global_numthreads >= 12 && thr == 1) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// printf ("loaded ln1_b: %s %s %d\n", zipfile, fn, sz);
    ...
    if ((global_numthreads >= 12 && thr == 2) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 3) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 4) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 5) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 6) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 7) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 8) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 9) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 10) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
...
// fflush(stdout);
    ...
    if ((global_numthreads >= 12 && thr == 11) || (global_numthreads < 12 && thr == 0) || thr == -1)
    {
