...
pfg-gpt-bloom: main.o loader.o model.o tokens.o glyphgen.o ui_sdl.o ui_tty.o lua.o inlines.o  zip.o raw_loader.o bf16.o fp16.o unpickle.o fastbarrier.o simd.o server.o base64.o fp32to8bit.o client.o utf8.o layer_cl.o conv1dline_cl.o thpool.o linear_transform_cl.o deviceinfoQuery.o getGPUinfo.o
	$(CC) $(OPT) $(OPT2) inlines.o main.o loader.o tokens.o glyphgen.o model.o ui_sdl.o ui_tty.o zip.o raw_loader.o bf16.o fp16.o fastbarrier.o simd.o lua.o unpickle.o server.o base64.o fp32to8bit.o client.o utf8.o layer_cl.o thpool.o conv1dline_cl.o linear_transform_cl.o deviceinfoQuery.o getGPUinfo.o -o pfg-gpt-bloom $(LIBS) -pthread
...
getGPUinfo.o: getGPUinfo.c
	$(CC) $(OPT) $(OPT2) -c getGPUinfo.c -D__MAIN__
...
deviceinfoQuery.o: deviceinfoQuery.c
	$(CC) $(OPT) $(OPT2) -c deviceinfoQuery.c		
