...
void check_cl_error(cl_int err_num, char* msg) {
  if(err_num != CL_SUCCESS) {
    printf_filter("[Error] OpenCL error code: %d in %s \n", err_num, msg);
    exit(EXIT_FAILURE);
  }
}
...
int deviceinfoQuery_main(void) {
  ...
  if(num_platforms_available == 0){
    printf_filter("No OpenCL capable platforms found ! \n");
    return EXIT_FAILURE;
  } else {
  ...
  for(int platform_idx = 0; platform_idx < num_platforms_available; platform_idx++) {
    ...
    printf_filter("\t\t [Platform %d] CL_PLATFORM_NAME: %s\n", platform_idx, str_buffer);
    ...
    printf_filter("\t\t [Platform %d] CL_PLATFORM_VENDOR: %s\n", platform_idx, str_buffer);
    ...
    printf_filter("\t\t [Platform %d] CL_PLATFORM_VERSION: %s\n", platform_idx, str_buffer);
    ...
    printf_filter("\t\t [Platform %d] CL_PLATFORM_PROFILE: %s\n", platform_idx, str_buffer);
    ...
    printf_filter("\t\t [Platform %d] CL_PLATFORM_EXTENSIONS: %s\n", platform_idx, str_buffer);
    ...
    for(int device_idx = 0; device_idx < num_devices_available; device_idx++) {
      ...
      printf_filter("\t\t\t [Platform %d] Device ID: %d\n", platform_idx, device_idx);
      printf_filter("\t\t\t ---------------------------\n\n");
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_NAME: %s\n", platform_idx, device_idx,str_buffer);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_VERSION: %s\n", platform_idx, device_idx,str_buffer);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DRIVER_VERSION: %s\n", platform_idx, device_idx,str_buffer);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_OPENCL_C_VERSION: %s\n", platform_idx, device_idx,str_buffer);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_MAX_CLOCK_FREQUENCY: %d MHz\n", platform_idx, device_idx, max_clock_freq);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_MAX_COMPUTE_UNITS: %d\n", platform_idx, device_idx, max_compute_units_available);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_LOCAL_MEM_SIZE: %llu KB\n", platform_idx, device_idx, (unsigned long long)local_mem_size/1024);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_MAX_WORK_GROUP_SIZE: %ld\n", platform_idx, device_idx, (long int)max_work_group_size);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS: %d\n", platform_idx, device_idx, max_work_item_dims);
      ...
      printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_MAX_WORK_ITEM_SIZES: ", platform_idx, device_idx);
      for (size_t work_item_dim = 0; work_item_dim < max_work_item_dims; work_item_dim++) {
                printf_filter("%ld ", (long int)work_item_sizes[work_item_dim]);
      }
      printf_filter("\n");
      ...
      if(image_support) {
        ...
        printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_IMAGE2D_MAX_WIDTH: %ld\n", platform_idx, device_idx, (long int)image_size);
        ...
        check_cl_error(err_num, "clGetDeviceInfo: Getting device image max 2d width");
        printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_IMAGE2D_MAX_HEIGHT: %ld\n", platform_idx, device_idx, (long int)image_size);
        ...
        printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_IMAGE3D_MAX_WIDTH: %ld\n", platform_idx, device_idx, (long int)image_size);
        ...
        printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_IMAGE3D_MAX_HEIGHT: %ld\n", platform_idx, device_idx, (long int)image_size);
        ...
        printf_filter("\t\t\t\t\t [Platform %d] [Device %d] CL_DEVICE_IMAGE3D_MAX_DEPTH: %ld\n", platform_idx, device_idx, (long int)image_size);
